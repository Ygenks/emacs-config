...
#+end_src
** [[https://www.gnu.org/software/poke/][GNU Poke]]
#+begin_src emacs-lisp :tangle yes :noweb no
...
#+begin_src emacs-lisp :tangle yes :noweb yes
  ...
  (use-package lsp-mode
      ...
      (lsp-completion-enable-additional-text-edit nil) ; disable automatic import on completion
...
#+NAME: org-web-tools-system-prerequisites
#+CAPTION: System prerequisites for org-web-tools package
- [[https://pandoc.org/installing.html][pandoc]] :: document converter

Convert web page into org-mode file
#+begin_src emacs-lisp :tangle no :noweb yes :noweb-ref org-web-tools-usepkg
  (use-package org-web-tools
      :straight t
      :after org
      :bind (("C-c w" . org-web-tools-read-url-as-org)))
#+end_src
** Hook
#+begin_src emacs-lisp :tangle README-loaddefs.el
  ;;;###autoload
